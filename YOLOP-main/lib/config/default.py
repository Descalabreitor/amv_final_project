...
_C.DATASET.MASKROOT = './Data/da_annotations' # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = './Data/ll_seg_anotations'     # the path of ll_seg_annotations folder
