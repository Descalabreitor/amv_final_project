...
_C.DATASET.DATAROOT = '/content/drive/MyDrive/AML/Final_project/Project/Data/images'  # the path of images folder
_C.DATASET.LABELROOT = '/content/drive/MyDrive/AML/Final_project/Project/Data/det_annotations'  # the path of det_annotations folder
...
_C.DATASET.LANEROOT = '/content/drive/MyDrive/AML/Final_project/Project/Data/ll_seg_anotations'  # the path of ll_seg_annotations folder
