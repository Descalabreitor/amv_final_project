...
_C.MODEL.NAME = 'YOLOP for drivable road'
_C.MODEL.STRU_WITHSHARE = False     #add share_block to segbranch
_C.MODEL.HEADS_NAME = ['']
_C.MODEL.PRETRAINED = ""
_C.MODEL.PRETRAINED_DET = ""
_C.MODEL.IMAGE_SIZE = [160, 160]  # width * height, ex: 192 * 256
...
_C.DATASET.DATAROOT = '/home/adri/Projects/Final_proyect_AMV/Data/images'       # the path of images folder
_C.DATASET.LABELROOT = '/home/adri/Projects/Final_proyect_AMV/Data/det_seg_labels'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/home/adri/Projects/Final_proyect_AMV/Data/labels/colormaps'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/home/adri/Projects/Final_proyect_AMV/Data/bdd_lane_gt'               # the path of ll_seg_annotations folder
